...
const DIETARY_CUISINE_MAP = {
  'Gluten-free': ['Steakhouse', 'Seafood', 'BBQ', 'Brazilian', 'Mediterranean', 'Greek', 'Mexican', 'Japanese'],
  'Dairy-free': ['Japanese', 'Chinese', 'Thai', 'Vietnamese', 'Korean', 'BBQ', 'Seafood', 'Mediterranean'],
  'Nut-free': ['Steakhouse', 'BBQ', 'Seafood', 'American', 'Burgers', 'Mexican', 'Italian'],
  'Carnivore': ['Steakhouse', 'BBQ', 'Brazilian', 'Seafood', 'Burgers', 'Korean'],
  'Paleo': ['Steakhouse', 'BBQ', 'Seafood', 'Mediterranean', 'Greek']
};

function getDietaryTags(cuisine) {
  const tags = [];
  for (const [diet, cuisines] of Object.entries(DIETARY_CUISINE_MAP)) {
